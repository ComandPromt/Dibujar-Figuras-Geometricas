...
public abstract class FigureColoree implements Serializable {
	...
	/**
	 * Liste des rectangles, change a chaque affichage des rectangle de selection,
	 * set a vide dans les autres cas
	 */
	...
	/**
	 * Permet d'avoir un point par rapport a une repesentation de lui meme en
	 * polygon
	 *
