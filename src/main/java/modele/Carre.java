...
public class Carre extends Polygone {
	...
	public void transforamtionFigure(Point selected, int difX, int difY) {
		...
		case 0:
			...
			int diffCoteX = this.getPoints().get(2).getX() - this.getPoints().get(0).getX();
		...
		case 1:
			...
			int diffCoteX1 = this.getPoints().get(3).getX() - this.getPoints().get(1).getX();
		...
		case 2:
			...
			int diffCoteX2 = this.getPoints().get(2).getX() - this.getPoints().get(0).getX();
		...
		case 3:
			...
			int diffCoteX3 = this.getPoints().get(3).getX() - this.getPoints().get(1).getX();
